...
#2. Kmer filtering
bbduk.sh in=Output/M10/M10_trimmed.q30.fastq out=Output/M10/M10_unmatched.q30.fq ref=/Users/kahotisthammer/programs/bbmap/resources/phix174_ill.ref.fa k=31 hdist=1 stats=Output/M10/stats30_2.txt
...
bwa mem -t 8 -k 15 -a SIV2 Output/M10/M10_unmatched.q30.fq  > Output/M10/M10_BWAmapped.sam
...
rm Output/M10/M10_trimmed.q30.fastq Output/M10/M10_unmatched.q30.fq Output/M10/M10_BWAmapped.sam
