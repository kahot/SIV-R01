...
mkdir Output/M10
#0 adapter trimming
bbduk.sh in1=Data/fastq/10_S10_L001_R1_001.fastq in2=Data/fastq/10_S10_L001_R2_001.fastq  out=Output/M10/M10_adp.trimmed.fastq ref=/Users/kahotisthammer/programs/bbmap/resources/adapters.fa ktrim=r k=23 mink=11 hdist=1 stats=Output/M10/stats_0.txt
