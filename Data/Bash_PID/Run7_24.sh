...
bwa mem -t 8 -B 0 -O 0 -L 50 -w 200 SIVB670 Output/PID_Consensus/Run7_24.consensus.fasta  > Output/sam/Run7_24.PID.BWA.sam

#bbmap.sh in=Output/PID_Consensus/Run7_24.consensus.fasta out=Output/bam_PID/Run7_24.PID.bbmap.sam

#2. convert sam to bam
samtools view -S -b Output/sam/Run7_24.PID.BWA.sam > Output/bam_PID/Run7_24.PID.BWA.bam
