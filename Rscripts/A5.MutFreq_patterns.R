...
samples<-samples[samples$File.name %in% names,]
...
ps<-ggplot(data=df, aes(x=pos, y=freq.mutations.ref))+
...
ggsave(plot=ps, "Output/Stock_MF.pdf", width = 7, height = 2)




#Plot mut freq (Divergence)
